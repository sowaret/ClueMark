...
const Options = ({ show }) => {
	...
	return show && (
		<div className="hide-active-game marTop10">
			...
			/>
			<label htmlFor="useDrOrchid">
				Swap Mrs. White for Dr. Orchid
			</label>
